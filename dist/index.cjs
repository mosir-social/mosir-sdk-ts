...
let graphql_sse = require("graphql-sse");
...
var MosirTransport = class {
	...
	constructor(options, endpoint) {
		...
		this.graphQLClient = new graphql_request.GraphQLClient(endpoint, { fetch: options.fetch });
	...
	createSseClient(extraHeaders) {
		return (0, graphql_sse.createClient)({
			url: this.endpoint,
...
function getOperationType(document) {
	const operation = (0, graphql.getOperationAST)(toDocumentNode(document), getOperationName(document));
...
function getOperationName(document) {
	return (0, graphql.getOperationAST)(toDocumentNode(document), void 0)?.name?.value;
}
function toDocumentNode(document) {
	if (typeof document === "string" || document instanceof String) return (0, graphql.parse)(String(document));
	return document;
}
function toQueryString(document) {
	if (typeof document === "string" || document instanceof String) return String(document);
	return (0, graphql.print)(document);
}
...
//#endregion
exports.AccountFieldsFragmentDoc = AccountFieldsFragmentDoc;
exports.AspectRatioFieldsFragmentDoc = AspectRatioFieldsFragmentDoc;
exports.AttachmentFieldsFragmentDoc = AttachmentFieldsFragmentDoc;
exports.AttachmentIdFieldsFragmentDoc = AttachmentIdFieldsFragmentDoc;
exports.BlockStatusInfoFieldsFragmentDoc = BlockStatusInfoFieldsFragmentDoc;
exports.DEFAULT_ENDPOINT = DEFAULT_ENDPOINT;
exports.FeedPostConnectionFieldsFragmentDoc = FeedPostConnectionFieldsFragmentDoc;
exports.FeedPostEdgeFieldsFragmentDoc = FeedPostEdgeFieldsFragmentDoc;
exports.GetAccountProfileDocument = GetAccountProfileDocument;
exports.GetBlockedAccountsDocument = GetBlockedAccountsDocument;
exports.GetCurrentAccountDocument = GetCurrentAccountDocument;
exports.GetDiscussionsDocument = GetDiscussionsDocument;
exports.GetFeedPostsDocument = GetFeedPostsDocument;
exports.GetFollowedAccountsDocument = GetFollowedAccountsDocument;
exports.GetFollowedPostCollectionsDocument = GetFollowedPostCollectionsDocument;
exports.GetFollowingAccountsDocument = GetFollowingAccountsDocument;
exports.GetFollowingPostsDocument = GetFollowingPostsDocument;
exports.GetHistoryPostsDocument = GetHistoryPostsDocument;
exports.GetLinkPreviewDocument = GetLinkPreviewDocument;
exports.GetMediaDocument = GetMediaDocument;
exports.GetMutualFollowersDocument = GetMutualFollowersDocument;
exports.GetMyPostCollectionsDocument = GetMyPostCollectionsDocument;
exports.GetNotificationsDocument = GetNotificationsDocument;
exports.GetPopularPostsDocument = GetPopularPostsDocument;
exports.GetPostCollectionDocument = GetPostCollectionDocument;
exports.GetPostCollectionsByAuthorDocument = GetPostCollectionsByAuthorDocument;
exports.GetPostDocument = GetPostDocument;
exports.GetPostDraftDocument = GetPostDraftDocument;
exports.GetPostDraftsCountDocument = GetPostDraftsCountDocument;
exports.GetPostDraftsDocument = GetPostDraftsDocument;
exports.GetPostReactionDetailsDocument = GetPostReactionDetailsDocument;
exports.GetPostReactionsDocument = GetPostReactionsDocument;
exports.GetProfileTagByIdDocument = GetProfileTagByIdDocument;
exports.GetProfileTagProfilesDocument = GetProfileTagProfilesDocument;
exports.GetReactedPostsDocument = GetReactedPostsDocument;
exports.GetTopicFeedPostsDocument = GetTopicFeedPostsDocument;
exports.GetTopicsDocument = GetTopicsDocument;
exports.GetUnreadNotificationCountDocument = GetUnreadNotificationCountDocument;
exports.GetUserPostsDocument = GetUserPostsDocument;
exports.GetUserReactionsDocument = GetUserReactionsDocument;
exports.LinkPreviewFieldsFragmentDoc = LinkPreviewFieldsFragmentDoc;
exports.ListProfileTagsDocument = ListProfileTagsDocument;
exports.MediaFileMetadataFieldsFragmentDoc = MediaFileMetadataFieldsFragmentDoc;
exports.MediaMetadataFieldsFragmentDoc = MediaMetadataFieldsFragmentDoc;
exports.MonoPostDraftFieldsFragmentDoc = MonoPostDraftFieldsFragmentDoc;
exports.NotificationConnectionFieldsFragmentDoc = NotificationConnectionFieldsFragmentDoc;
exports.NotificationFieldsFragmentDoc = NotificationFieldsFragmentDoc;
exports.NotificationReceivedDocument = NotificationReceivedDocument;
exports.PageInfoFieldsFragmentDoc = PageInfoFieldsFragmentDoc;
exports.PostCollectionConnectionFieldsFragmentDoc = PostCollectionConnectionFieldsFragmentDoc;
exports.PostCollectionFieldsFragmentDoc = PostCollectionFieldsFragmentDoc;
exports.PostCollectionReferenceFieldsFragmentDoc = PostCollectionReferenceFieldsFragmentDoc;
exports.PostConnectionFieldsFragmentDoc = PostConnectionFieldsFragmentDoc;
exports.PostCreatedByAuthorDocument = PostCreatedByAuthorDocument;
exports.PostCreatedInCollectionDocument = PostCreatedInCollectionDocument;
exports.PostDeletedDocument = PostDeletedDocument;
exports.PostDraftConnectionFieldsFragmentDoc = PostDraftConnectionFieldsFragmentDoc;
exports.PostDraftFieldsFragmentDoc = PostDraftFieldsFragmentDoc;
exports.PostFieldsFragmentDoc = PostFieldsFragmentDoc;
exports.PostOperationPermissionFieldsFragmentDoc = PostOperationPermissionFieldsFragmentDoc;
exports.PostOptionsFieldsFragmentDoc = PostOptionsFieldsFragmentDoc;
exports.PostReactionDetailRecordConnectionFieldsFragmentDoc = PostReactionDetailRecordConnectionFieldsFragmentDoc;
exports.PostReactionsConnectionFieldsFragmentDoc = PostReactionsConnectionFieldsFragmentDoc;
exports.PostReferenceFieldsFragmentDoc = PostReferenceFieldsFragmentDoc;
exports.PostUpdatedDocument = PostUpdatedDocument;
exports.PostVisibilityFieldsFragmentDoc = PostVisibilityFieldsFragmentDoc;
exports.ProfileConnectionFieldsFragmentDoc = ProfileConnectionFieldsFragmentDoc;
exports.ProfileFieldsFragmentDoc = ProfileFieldsFragmentDoc;
exports.ProfileFollowStatusFieldsFragmentDoc = ProfileFollowStatusFieldsFragmentDoc;
exports.ProfileReferenceFieldsFragmentDoc = ProfileReferenceFieldsFragmentDoc;
exports.ProfileTagConnectionFieldsFragmentDoc = ProfileTagConnectionFieldsFragmentDoc;
exports.ProfileTagFieldsFragmentDoc = ProfileTagFieldsFragmentDoc;
exports.ReactionDetailRecordFieldsFragmentDoc = ReactionDetailRecordFieldsFragmentDoc;
exports.ReactionSummaryFieldsFragmentDoc = ReactionSummaryFieldsFragmentDoc;
exports.ReactionTypeFieldsFragmentDoc = ReactionTypeFieldsFragmentDoc;
exports.ReplyCreatedUnderRootPostDocument = ReplyCreatedUnderRootPostDocument;
exports.TopicFieldsFragmentDoc = TopicFieldsFragmentDoc;
exports.UserReactionStatisticsFieldsFragmentDoc = UserReactionStatisticsFieldsFragmentDoc;
exports.UserReactionsStatisticsConnectionFieldsFragmentDoc = UserReactionsStatisticsConnectionFieldsFragmentDoc;
exports.createMosirClient = createMosirClient;
