 ...
 *
 */
import { RequestParams, Sink, StreamMessage, ExecutionResult, StreamEvent } from './common.mjs';
...
export interface ClientOptions<SingleConnection extends boolean = false> {
     ...
     */
    url: string | ((request: SingleConnection extends true ? undefined : RequestParams) => Promise<string> | string);
    /**
     ...
     * The request is passed for distinct connections mode only.
     */
    headers?: Record<string, string> | ((request: SingleConnection extends true ? undefined : RequestParams) => Promise<Record<string, string>> | Record<string, string>);
    /**
